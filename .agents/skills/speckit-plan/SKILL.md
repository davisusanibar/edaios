---
name: speckit-plan
description: Crea un plan tecnico trazable, condicionado por la Constitucion y los gates EDAIOS. Usar cuando spec y checklist esten listos para convertir requisitos aprobados en decisiones tecnicas.
---
