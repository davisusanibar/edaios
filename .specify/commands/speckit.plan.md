...
trigger: Usar cuando spec y checklist esten listos para convertir requisitos aprobados en decisiones tecnicas.
short_description: Crea el plan tecnico gobernado EDAIOS
default_prompt: Use $speckit-plan para crear el plan tecnico de la especificacion activa.
---
