...
display_name: Spec Kit Constitution
description: Verifica o recompila la constitucion operativa como proyeccion gobernada de Foundation.
trigger: Usar cuando cambie Foundation, la receta de destilacion o se necesite comprobar deriva constitucional.
short_description: Compila la constitucion operativa EDAIOS
default_prompt: Use $speckit-constitution para verificar o recompilar la constitucion operativa EDAIOS.
---
