...
| Evidencia | `specs/016-onboarding-de-consumer-real/evidence/sc-002-consumer-real.json` (negativa con digests, re-siembra con sidecar gobernado, corridas 43/43 y 18/18 con `--profile consumer-release`). |
